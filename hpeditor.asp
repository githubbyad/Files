...
response.write("<script type='text/javascript' src='{{PutHName}}{{PutTFolder}}.js'></script>")
response.write("<link type='text/css' rel='stylesheet' href='{{PutHName}}/ufields.css'>")
...
response.write("<a href='{{Home}}?hle' target='_blank' title='View your Homepage without Editor'>Preview Homepage<i class='fa fa-external-link' aria-hidden='true'></i></a>")
response.write("</div>")
response.write("</div>")
response.write("<iframe class='hpx-iframe' src='{{Home}}?hp_editor'>")
response.write("</div>")
response.write("</body>")
response.write("</html>")
%>