...
response.write("if (typeof SMThemeColor == 'function') {")
...
response.write("$('.hpx-loader').animate({opacity: 0}, 400, function() {$('.hpx-loader').css('display','none');	});")
...
response.write("<div class='hpx-links'>")
...
response.write("</div>")
response.write("<div class='hpx-sm hpx-refresh'>")
response.write("<a href='javascript:void(0);' title='Refresh' onClick='window.location.reload(true);'>Refresh<i class='fa fa-refresh' aria-hidden='true'></i></a>")
response.write("</div>")
response.write("<div class='hpx-homepage'>")
response.write("<a href='/clients/bulletlink//staff-aai-22922/index90.htm?hle' target='_blank' title='Preview Homepage without Editor'>Preview<i class='fa fa-external-link' aria-hidden='true'></i></a>")
response.write("</div>")
response.write("<div class='hpx-homepage hpx-support'>")
response.write("<a href='/form2.asp?lid=SupportTickets&lid2=&level=1&pform=support_tickets&pkeyname=ticket_id&pkey=&fkeyname=&fkey=&eflag=Yes&wpage=&hpath=&smid=&u=&c=&lf=&x=' target='_blank' title='Create Support Ticket'>Get Help<i class='fa fa-question-circle' aria-hidden='true'></i></a>")
response.write("</div>")
response.write("<div class='hpx-homepage hpx-logout'>")
response.write("<a href='/logout.asp' title='Logout'>Logout<i class='fa fa-sign-out' aria-hidden='true'></i></a>")
response.write("</div>")
response.write("</div>")
response.write("</div>")
