        ...
        <div class="w-100 bg-section p-3 mb-4 rounded shadow">
            ...
            <div class="d-flex justify-content-evenly">
                <span class="text-center fw-bold fs-4">
                    ...
                    <?= count($orders->where_interval([], [], 'date_timestamp', '1 DAY')) ?>
                </span>
                <span class="text-center fw-bold fs-4">
                    <b class="text-muted fw-normal fs-6">This week</b><br>
                    <?= count($orders->where_interval([], [], 'date_timestamp', '1 WEEK')) ?>
                </span>
                <span class="text-center fw-bold fs-4">
    ...
    <div class="col-lg-3">
        ...
        <div class="w-100 bg-section p-3 mb-4 rounded shadow">
            ...
            <div class="d-flex justify-content-evenly">
                <span class="text-center fw-bold fs-4">
                    <b class="text-muted fw-normal fs-6">This week</b><br>
                    <?= count($orders->where_interval(['customer_repeat' => 'on'], [], 'date_timestamp', '1 WEEK')) ?>
                </span>
                <span class="text-center fw-bold fs-4">
                    <b class="text-muted fw-normal fs-6">Overall</b><br>
