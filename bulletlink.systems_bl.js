...
function OpenLoginPopup(ctl) {
           ...
           if (a == '1' && s != 'Yes') {
             ...
             //  var larr = arr[arr.length-2];
             //  if (larr.indexOf('.') === - 1) {   
             //   window.open('/clients/bulletlink/' + larr +'/index0.htm?sname=target_form.asp&pform={{Login}}', target='_parent');
             //                    }
             //  else {
                 window.open('/index0.htm?sname=target_form.asp&pform={{Login}}', target='_parent');
                 return false;
              //      }
           }
           else {
        ...
        function checkLoginStatus(isRestricted) {
            ...
            //var lurl = location.href.match(/:\/\/(.[^/]+)/)[1]; // Actual domain
            var lurl = "bulletlink.systems"; // hard coded "bulletlink.systems" domain

            if (sname.length > 0) {
				if (urlhttps == true) {
                var sframe = "<iframe id=\"IFrameContent\" name=\"IFrameContent\" marginwidth=\"0\" marginheight=\"0\" hspace=\"0\" vspace=\"0\" frameborder=\"0\" scrolling=\"no\" width=100% onload=\"ResizeIFrame('IFrameContent');\" src=\"https://" + lurl + "/" + sname + qs + "\"></iframe>"
				}
				else
				{
                var sframe = "<iframe id=\"IFrameContent\" name=\"IFrameContent\" marginwidth=\"0\" marginheight=\"0\" hspace=\"0\" vspace=\"0\" frameborder=\"0\" scrolling=\"no\" width=100% onload=\"ResizeIFrame('IFrameContent');\" src=\"http://" + lurl + "/" + sname + qs + "\"></iframe>"
				}
