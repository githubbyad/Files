...
function Datepicker() {
	this._defaults = {
		...
		yearRange: 'c-60:c+10', // Range of years to show in drop-down: 'any' for direct text entry
	...
	this.regional = {
		'': { // US/English
			...
			prevText: '<img border="0" src="http://bulletlink.com/jquery/calendar/arrow-left.gif">', // Text for the previous month command
			prevStatus: 'Show the previous month', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Show the previous year', // Status text for the previous year command
			nextText: '<img border="0" src="http://bulletlink.com/jquery/calendar/arrow-right.gif">', // Text for the next month command
			...
			clearText: '<img border="0" src="http://bulletlink.com/jquery/calendar/clear.gif" align="left">', // Text for the clear command
			clearStatus: 'Clear all the dates', // Status text for the clear command
			closeText: '<img border="0" src="http://bulletlink.com/jquery/calendar/close.gif" align="right">', // Text for the close command
