 ...
 do while not rsResults.eof
  ...
  if V_PollType = "MultipleChoice-CheckBox" then
   ...
   if ClosePollFlag = "No" then
    MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid1"" id=""choiceid1"" value=1 class=""choiceid1_custom cus-poll-1-input form-check-input""></td>"
   else
   ...
   if V_Answer3 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid3"" id=""choiceid3"" value=1 class=""choiceid3_custom cus-poll-1-input form-check-input""></td>"
    else
     if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer4 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid4"" id=""choiceid4"" value=1 class=""choiceid4_custom cus-poll-1-input form-check-input""></td>"
    else
     if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer5 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question polls1question_customcus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid5"" id=""choiceid5"" value=1 class=""choiceid5_custom cus-poll-1-input form-check-input""></td>"
    else
     if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer6 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid6"" id=""choiceid6"" value=1 class=""choiceid6_custom cus-poll-1-input form-check-input""></td>"
    else
     if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer7 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""checkbox"" name=""choiceid7"" id=""choiceid7"" value=1 class=""choiceid7_custom cus-poll-1-input form-check-input""></td>"
    else
     if DisplayDetailPollFlag = "Yes" then    
   ...
   if ClosePollFlag = "No" then
    MyContent = MyContent + "<tr class=""polls1question polls1question_custom cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""radio"" name=""choiceid"" value=1 id=""choiceid1"" class=""choiceid1_custom cus-poll-1-input form-check-input""></td>"
   else
    if DisplayDetailPollFlag = "Yes" then    
     ShowDetails = "<TD align=right style=""border: 1px solid " + BarBGColor + ";"">" + CStr(P1Responded) + "&nbsp; " + ReportVotesValue + "</TD>"
    end if
   ...
   if V_Answer3 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""radio"" name=""choiceid"" id=""choiceid3"" value=3 class=""choiceid3_custom cus-poll-1-input form-check-input""></td>"
    else
    if DisplayDetailPollFlag = "Yes" then    
     ShowDetails = "<TD align=right style=""border: 1px solid " + BarBGColor + ";"">" + CStr(P3Responded) + "&nbsp; " + ReportVotesValue + "</TD>"
    end if
   ...
   if V_Answer4 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""radio"" name=""choiceid"" id=""choiceid4"" value=4 class=""choiceid4_custom cus-poll-1-input form-check-input""></td>"
    else
    if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer5 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""radio"" name=""choiceid"" id=""choiceid5"" value=5 class=""choiceid5_custom cus-poll-1-input form-check-input""></td>"
    else
    if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer6 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question cus-poll-1-answers form-check""><td align=right valign=top width=""15px"" CLASS=WB><input type=""radio"" name=""choiceid"" id=""choiceid6"" value=6 class=""choiceid6_custom cus-poll-1-input form-check-input""></td>"
    else
    if DisplayDetailPollFlag = "Yes" then    
   ...
   if V_Answer7 <> "" then
    if ClosePollFlag = "No" then
     MyContent = MyContent + "<tr class=""polls1question cus-poll-1-answers form-check""><td align=right valign=top width=""15px""><input type=""radio"" name=""choiceid"" id=""choiceid7"" value=7 class=""choiceid7_custom cus-poll-1-input form-check-input""></td>"
    else
    if DisplayDetailPollFlag = "Yes" then    
