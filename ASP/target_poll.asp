...
'response.write strSQLp 
 ...
 if AlreadyVoted  then
  Response.Write "<center class='cus-poll-voted'><svg xmlns='http://www.w3.org/2000/svg' style='display: none;'><symbol id='exclamation-triangle-fill' fill='currentColor' viewBox='0 0 16 16'>
