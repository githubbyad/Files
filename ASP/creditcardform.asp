...
if Session("GatewayMessage") = "" then
  ...
  Response.Write "<center><FORM id=""CustomForm"" class=""custom-form p-3 p-lg-5 mx-2 mx-lg-0 border border-success rounded col-lg-5 mb-4 bg-body"" METHOD=post ACTION=" + AppServer + "/creditcardform.asp?uid=" + Request.QueryString("uid") + "&site=" + Request.QueryString("site") + " name=form onSubmit=""return Vailidate(this)"">"
  ...
  if Request.Form("expiration_month") = "" then
    ...
    Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""expiration_month"" VALUE=" + Request.Form("expiration_month") + " id=""expiration_month"" maxlength=""50"" placeholder=""Expiration Month"" type=""number"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""expiration_month"" class=""form-label"" style=""color: #004500;"">Expiration Month</label><div></section>"
  end if 

  if Request.Form("expiration_year") = "" then
    Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""select w-100 form-floating""><select id=""expiration_year"" name=""expiration_year"" required class=""form-select"" required><option value="""" selected="""">-- Select Expiration Year --</option><option required="""" value=""2021"">2021</option><option required="""" value=""2022"">2022</option><option required="""" value=""2023"">2023</option><option required="""" value=""2024"">2024</option><option required="""" value=""2025"">2025</option><option required="""" value=""2026"">2026</option><option required="""" value=""2027"">2027</option><option required="""" value=""2028"">2028</option><option required="""" value=""2029"">2029</option><option required="""" value=""2030"">2030</option><option required="""" value=""2031"">2031</option><option required="""" value=""2032"">2032</option><option required="""" value=""2033"">2033</option><option required="""" value=""2034"">2034</option><option required="""" value=""2035"">2035</option><option required="""" value=""2036"">2036</option><option required="""" value=""2037"">2037</option><option required="""" value=""2038"">2038</option><option required="""" value=""2039"">2039</option><option required="""" value=""2040"">2040</option><option required="""" value=""2041"">2041</option><option required="""" value=""2042"">2042</option><option required="""" value=""2043"">2043</option><option required="""" value=""2044"">2044</option><option required="""" value=""2045"">2045</option><option required="""" value=""2046"">2046</option></select><label for=""expiration_year"" class=""form-label"" style=""color: #004500;"">Expiration Year</label></div></section>"
  else
    Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""expiration_year"" VALUE=" + Request.Form("expiration_year") + " id=""expiration_year""  maxlength=""50"" placeholder=""Expiration Year"" type=""number"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""expiration_year"" class=""form-label"" style=""color: #004500;"">Expiration Year</label><div></section>"
  end if 

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""cvv"" VALUE=""" + Request.Form("cvv") + """ id=""cvv"" maxlength=""50"" placeholder=""CVV"" type=""number"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""cvv"" class=""form-label"" style=""color: #004500;"">CVV</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""total_amount"" VALUE=""" + CStr(Amount) + """ id=""total_amount"" maxlength=""50"" placeholder=""Amount"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" DISABLED><label for=""total_amount"" class=""form-label"" style=""color: #004500;"">Amount</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""first_name"" VALUE=""" + Request.Form("first_name") + """ id=""first_name"" maxlength=""50"" placeholder=""First Name"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""first_name"" class=""form-label"" style=""color: #004500;"">First Name</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""last_name"" VALUE=""" + Request.Form("last_name") + """ id=""last_name"" maxlength=""50"" placeholder=""Last Name"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""last_name"" class=""form-label"" style=""color: #004500;"">Last Name</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""company"" VALUE=""" + company + """ id=""company"" maxlength=""50"" placeholder=""Company"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required DISABLED><label for=""company"" class=""form-label"" style=""color: #004500;"">Company</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""address"" VALUE=""" + Request.Form("address") + """ id=""address"" maxlength=""50"" placeholder=""Address"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""address"" class=""form-label"" style=""color: #004500;"">Address</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""city"" VALUE=""" + Request.Form("city") + """ id=""city"" maxlength=""50"" placeholder=""City"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""city"" class=""form-label"" style=""color: #004500;"">City</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""select w-100 form-floating""><select id=""state"" name=""state"" required class=""form-select"" required><OPTION>AK</OPTION><OPTION>AL</OPTION><OPTION>AR</OPTION><OPTION>AZ</OPTION><OPTION>CA</OPTION><OPTION>CO</OPTION><OPTION>CT</OPTION><OPTION>DC</OPTION><OPTION>DE</OPTION><OPTION>FL</OPTION><OPTION>GA</OPTION><OPTION>GU</OPTION><OPTION>HI</OPTION><OPTION>IA</OPTION><OPTION>ID</OPTION><OPTION>IL</OPTION><OPTION>IN</OPTION><OPTION>KS</OPTION><OPTION>KY</OPTION><OPTION>LA</OPTION><OPTION>MA</OPTION><OPTION>MD</OPTION><OPTION>ME</OPTION><OPTION>MI</OPTION><OPTION>MN</OPTION><OPTION>MO</OPTION><OPTION>MS</OPTION><OPTION>MT</OPTION><OPTION SELECTED VALUE=N/A>N/A</OPTION><OPTION>NC</OPTION><OPTION>ND</OPTION><OPTION>NE</OPTION><OPTION>NH</OPTION><OPTION>NJ</OPTION><OPTION>NM</OPTION><OPTION>NV</OPTION><OPTION>NY</OPTION><OPTION>OH</OPTION><OPTION>OK</OPTION><OPTION>OR</OPTION><OPTION>PA</OPTION><OPTION>RI</OPTION><OPTION>SC</OPTION><OPTION>SD</OPTION><OPTION>TN</OPTION><OPTION>TX</OPTION><OPTION>UT</OPTION><OPTION>VA</OPTION><OPTION>VT</OPTION><OPTION>WA</OPTION><OPTION>WI</OPTION><OPTION>WV</OPTION><OPTION>WY</OPTION></select><label for=""state"" class=""form-label"" style=""color: #004500;"">State</label></div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""zip_code"" VALUE=""" + Request.Form("zip_code") + """ id=""zip_code"" maxlength=""50"" placeholder=""Zip / Postal Code"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""zip_code"" class=""form-label"" style=""color: #004500;"">Zip / Postal Code</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""phone"" VALUE=""" + Request.Form("phone") + """ id=""phone"" maxlength=""50"" placeholder=""Phone"" type=""text"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""phone"" class=""form-label"" style=""color: #004500;"">Phone</label><div></section>"

  Response.Write "<section class=""w-96 mb-3"" style=""margin-left:2%""><div class=""input w-100 form-floating""><INPUT NAME=""email"" VALUE=""" + Request.Form("email") + """ id=""email"" maxlength=""50"" placeholder=""Email"" type=""email"" class=""formfieldinput formfieldinput_custom form-control"" required><label for=""email"" class=""form-label"" style=""color: #004500;"">Email</label><div></section>"
