...
<body class="bg-theme p-lg-3">
    ...
    <div class="container col-lg-6 bg-body rounded px-0 mb-5 shadow border-1">
        ...
        <h1 class="text-theme py-3 text-center rounded-top fw-bold" style="background-color:var(--themeColor1);border-bottom: 2px solid var(--themeColor2) !important;">TV - 2</h1>
        ...
        <form class="p-3 mt-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-block rounded mb-4">
                    <p class="fw-bold mb-0 position-relative">
                        <span class="text-light py-2 px-3 d-inline-block rounded-top position-relative" style="left:1rem;background: linear-gradient(to bottom, var(--themeColor1), var(--themeColor2));">Arrow</span>
                    </p>
                    <div class="d-block-w-100 border border-2 border-dark pt-3 rounded" style="background-color: #f4f4f4">
                        <div class="mb-3 px-3">
                            <label class="form-label">Text:</label>
                        ...
                        <div class="styles">
                            ...
                            <div class="style_on d-none">
                                ...
                                <div class="mb-3 px-3">
                                    <label class="form-label">Arrow Position from Left:</label>
                                    <input type="text" class="form-control" id="selectSouceLeft">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 d-block rounded mb-4">
                    <p class="fw-bold mb-0 position-relative">
                        <span class="text-light py-2 px-3 d-inline-block rounded-top position-relative" style="left:1rem;background: linear-gradient(to bottom, var(--themeColor1), var(--themeColor2));">All Souces</span>
                    </p>
                    <div class="d-block-w-100 border border-2 border-dark pt-3 rounded" style="background-color: #f4f4f4">
                        <div class="mb-3 px-3">
                            <label class="form-label">List:</label>
                            <textarea class="form-control" id="allSouceList" style="height: 100px"></textarea>
                            <div class="form-text">Add "--" before name to set as unavailable.</div>
                        </div>
                        <div class="styles">
                            <p class="styles_active px-3 text-dark fw-bold fst-italic" style="cursor: pointer;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-right me-2" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
                            ...
                            <div class="style_on d-none">
                                <div class="mb-3 px-3">
                                    <label class="form-label">Background Color:</label>
                                    <input type="text" class="form-control" id="allSouceBackgroundColor">
                                </div>
                                <div class="mb-3 px-3">
                                    <label class="form-label">Color:</label>
    ...
    <script>
        ...
        const getData = async () => {
            ...
            const souceList = () => {
                let list = "";
                tv.allSouces.list.forEach(s => list += `${s}\n`);
                return list;
            }
            ...
            document.querySelector("#allSouceColor").value = tv.allSouces.color;
            document.querySelector("#allSouceBackgroundColor").value = tv.allSouces.backgroundColor;
            document.querySelector("#allSouceFontSize").value = tv.allSouces.fontSize;
            document.querySelector("#allSouceGap").value = tv.allSouces.gap;

            // arrow
            document.querySelector("#selectSouceText").value = tv.selectSouce.text;
            document.querySelector("#selectSouceColor").value = tv.selectSouce.color;
            document.querySelector("#selectSouceFontSize").value = tv.selectSouce.fontSize;
            document.querySelector("#selectSouceGap").value = tv.selectSouce.gap;
            document.querySelector("#selectSouceLeft").value = tv.selectSouce.left;
