                        ...
                        if (issueDate <= stopDate) {  
                            ...
                            form.addEventListener("submit", function (event) {
                                if (!window.location.href.includes('&subx=Y')) {
                                    ...
                                    alert(`The Article body is currently blank. <br><br>To proceed, please click on the "View Article" link below, then copy the content of the article body and paste it into the designated "Body" field.<br><br> <a href="https://google.com" target="_blank" style="text-decoration: underline !important;">View Article</a><br><br>`);
                                }
                            });
                        }
                    }
