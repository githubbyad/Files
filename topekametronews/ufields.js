...
function confirmdelete(msg, url) { // Confirm Popup
    jConfirm2(msg, 'Delete', function(r) {
        if (r) {
            ...
            createCookie('hpe_delete2', 'Yes');
            createCookie('hpe_blank', 'Yes');
        }
    });
    return false;
}
...
function confirmdetail(msg, url, index) { // Confirm Popup - Detail
    jConfirm2(msg, 'Delete', function(r) {
        if (r) {
            OpenBLPopup('' + url + '', 'iframe');
            createCookie('hpe_detail_delete2', index);
            createCookie('hpe_blank', 'Yes');
        }
    });
    return false;
    ...
    if ($(document).width() > 1024) {
        ...
        if (window.location.href.indexOf("?hp_editor") != -1 || window.location.href.indexOf("&hp_editor") != -1) {
            if (readCookie('hpe_success_delete')) { // If Deactivated Something
                ...
                eraseCookie('hpe_success_delete');
                alert(sdt);
            }
            if (readCookie('hpe_delete2')) { // If Deleted Something
                var sdt = 'Deleted Sucessfully';
                eraseCookie('hpe_delete2');
                alert(sdt);
            }
            if (readCookie('hpe_detail_delete2')) { // If Deleted Something from Detail Page
                var sdt = 'Deleted Sucessfully';
                eraseCookie('hpe_detail_delete2');
                alert(sdt);
            }
            ...
            $('#IFrameContent[src*="target_yellowpage' + pext + '"]').parent('#MainContent').addClass('hpe-old-directory'); // Add Old Directory Class
            $('#IFrameContent[src*="target_classifieds' + pext + '"]').parent('#MainContent').addClass('hpe-old-classified'); // Add Old Classified View Class
            ...
            if ($('.hpe-logo').length) {
                $('.hpe-logo').each(function() {
                    ...
                    if ($(this).children('#logo').children('img').length) {
                        ...
                        $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit Logo" href="#hp_editor" onclick="clearCookieLB();OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=&hpe=Y#hpe_logo_img\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a title="View Homepage" href="' + sp + '"><i class="fa fa-external-link" aria-hidden="true"></i><b class="hp-llable">View</b></a><a class="hp-help hp-tt" href="#hp_editor" title="' + hlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a></div><header class="hp-hheader">Logo</header><cpanel></cpanel><rpanel>' + rwt + '</rpanel></div>');
                    } else {
                        var hlp = 'Upload logo image with recommended width showing on bottom right side.<br><b>NOTE:</b> There is no limit for the height.';
                        $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit Logo" href="#hp_editor" onclick="clearCookieLB();OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=&hpe=Y#hpe_logo_img\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a title="View Homepage" href="' + sp + '"><i class="fa fa-external-link" aria-hidden="true"></i><b class="hp-llable">View</b></a><a class="hp-help hp-tt" href="#hp_editor" title="' + hlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a></div><header class="hp-hheader">Logo</header><cpanel></cpanel><rpanel>' + rwt + '</rpanel></div>');
                    }
            ...
            if ($('.hpe-in-section').length) { // Specific Article
                $('.hpe-in-section').each(function() {
                    ...
                    var isdate = $(this).attr('data-date');
                    var durl = $(this).attr('data-url');
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" title="Edit Article" onclick="OpenBLPopup(\'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=' + haid + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&hpe=Y&fpx=section#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a href="#hp_editor" title="Add New Article" onclick="OpenBLPopup(\'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&fpx=section&x=&hpe=Y&isdate=' + isdate + '#hpe_prevxy$$' + m + '&&' + s + '\',\'iframe\');"><i class="fa fa-plus" aria-hidden="true"></i><b class="hp-llable">New</b></a><a href="#hp_editor" title="Delete Article" onclick="return confirmdelete(\'' + dl1 + ' Article' + dl2 + '\', \'/' + pdist + 'lid=Pages&lid2=&level=1&pform=pages&dname=Pages&pkeyname=sys_information_id&pkey=' + haid + '&wpage=1&hpath=&sflag=&sortflag=&fa=&dflag=Y&smid=&u=&c=&lf=&x=&hpe=Y\');"><i class="fa fa-trash" aria-hidden="true"></i><b class="hp-llable">Delete</b></a><a title="View Article" href="' + durl + '"><i class="fa fa-external-link" aria-hidden="true"></i><b class="hp-llable">View</b></a></div></div>');
                });
            ...
            if ($('.hpe-article-detail').length) {
                $('.hpe-article-detail').each(function() {
                    ...
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" title="Edit Article" onclick="OpenBLPopup(\'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=' + daid + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&hpe=Y&fpx=art_detail#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a href="#hp_editor" class="detail_delete" title="Delete Article" onclick="return confirmdetail(\'' + dl1 + ' Article' + dl2 + '\', \'/' + pdist + 'lid=Pages&lid2=&level=1&pform=pages&dname=Pages&pkeyname=sys_information_id&pkey=' + daid + '&wpage=1&hpath=&sflag=&sortflag=&fa=&dflag=Y&smid=&u=&c=&lf=&x=&hpe=Y\', \'' + sbid + '\');"><i class="fa fa-trash" aria-hidden="true"></i><b class="hp-llable">Delete</b></a></div></div>');
                });
            }
            ...
            if ($('.hpe-event-detail').length) {
                $('.hpe-event-detail').each(function() {
                    var daid = $(this).attr('data-detailid');
                    var sbid = $(this).attr('data-submenu');
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" title="Edit Event" onclick="OpenBLPopup(\'/' + pfist + 'lid=Events2&lid2=&level=1&pform=events2&pkeyname=sys_information_id&pkey=' + daid + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&hpe=Y&fpx=event_detail#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a href="#hp_editor" class="detail_delete" title="Delete Article" onclick="return confirmdetail(\'' + dl1 + ' Event' + dl2 + '\', \'/' + pdist + 'lid=Events2&lid2=&level=1&pform=events2&dname=Events2&pkeyname=sys_information_id&pkey=' + daid + '&wpage=1&hpath=&sflag=&sortflag=&fa=&dflag=Y&smid=&u=&c=&lf=&x=&hpe=Y\', \'' + sbid + '\');"><i class="fa fa-trash" aria-hidden="true"></i><b class="hp-llable">Delete</b></a></div></div>');
                });
            }
            ...
            // ArticleGroup
            if ($('.hpe-in-artgroup2').length) {
                $('.hpe-in-artgroup2').each(function() {
                    var m = $(this).attr('data-menu').replace(/'/g, "@@").replace(/ /g, "_");
                    var s = $(this).attr('data-submenu').replace(/'/g, "@@").replace(/ /g, "_");
                    var haid = $(this).attr('data-article');
                    var isdate = $(this).attr('data-date');
                    var durl = $(this).attr('data-url');
                    $(this).addClass('hp-ppp');
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" title="Edit" onclick="OpenBLPopup(\'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=' + haid + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&hpe=Y&fpx=preview&dbx=Yes#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a href="#hp_editor" title="Add New" onclick="OpenBLPopup(\'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&dbx=Yes&hpe=Y&isdate=' + isdate + '#hpe_prevxy$$' + m + '&&' + s + '\',\'iframe\');"><i class="fa fa-plus" aria-hidden="true"></i><b class="hp-llable">New</b></a><a href="#hp_editor" title="Delete" onclick="return confirmdelete(\'' + dl1 + ' Article' + dl2 + '\', \'/' + pfist + 'lid=Pages&lid2=&level=1&pform=pages&pkeyname=sys_information_id&pkey=' + haid + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&hpe=Y#hpe_deletex\');"><i class="fa fa-trash" aria-hidden="true"></i><b class="hp-llable">Delete</b></a></div></div>');
                });
            }
            ...
            var s = setInterval(function() {
                ...
                if (readCookie('hpe_delete_close') == 'Yes') { // Delete
                    clearTimeout(s);
                    eraseCookie('hpe_delete_close');
                    $('.hpe-loader.hpe-loader-start').removeClass('hpe-loader-restart');
                    $('.hp-x-popup').addClass('hp-sslidex');
                    $('.hpe-iframe').animate({ opacity: 0 }, 500);
                    window.location.reload();
                }
                if (readCookie('hpe_detail_delete_close') == 'Yes') { // Detail Delete
                    clearTimeout(s);
                    var i = readCookie('hpe_detail_delete2');
                    eraseCookie('hpe_detail_delete_close');
                    $('.hpe-loader.hpe-loader-start').removeClass('hpe-loader-restart');
                    $('.hp-x-popup').addClass('hp-sslidex');
                    $('.hpe-iframe').animate({ opacity: 0 }, 500);
                    window.location = 'index' + i + '.htm?hp_editor';
                }
                ...
                $('.hp-x-popup .mfp-close').click(function() {
                    ...
                    if (readCookie('hpe_submit') == 'Yes') {
                        ...
                        if (readCookie('hpe_detail_delete') && readCookie('hpe_rurl')) {
                            ...
                            eraseCookie('hpe_rurl');
                            createCookie('hpe_success_delete', 'Deleted Successfully');
        ...
        $('.hp-slide .hp-x .hp-y .hp-z .hp-span').append('<a class="hp-help hp-tt" href="#hp_editor" title="' + shlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a>');
        $('.hp-slide-left .hp-x .hp-y .hp-z .hp-span').append('<a class="hp-help hp-tt" href="#hp_editor" title="' + shlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a>');
        $('.hp-slide-up .hp-x .hp-y .hp-z .hp-span').append('<a class="hp-help hp-tt" href="#hp_editor" title="' + shlp_up + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a>');
...
$(document).ready(function() {
    ...
    if (window.location.href.indexOf("#hpe_updatex") != -1 && window.location.href.indexOf("/form") != -1 && window.location.href.indexOf("&eflag=") != -1) { // Article/Ad/Poll/Section Screen
        ...
        if (window.location.href.indexOf("&dbx=Yes") != -1) { // If Menus of Debra Client
            $('.hpe-my-form fieldset section').css('display', 'none');
            $('.label.col.col-4').each(function() {
                if ($(this).text() == 'BodyClick below:PageDesigner 2PageDesigner 1') {
                    $(this).text('Body');
                }
                if ($(this).text() == '* Heading' || $(this).text() == 'Body') {
                    $(this).parent('.row').parent('section').css('display', 'block');
                }
            });
        }
        ...
        if ($('#submit1').length || $('#submit2').length) {
            ...
            var ht = setInterval(function() {
                if ($('#token').val() != '') {
                    clearInterval(ht);
                    createCookie('hpe_hide_iframe', 'Yes');
                    createCookie('hpe_success_delete', 'Hide Successfully from <b>Highlight - ' + hs + '</b>');
                    $('#submit1').click();
                }
            }, 1000);
        }
